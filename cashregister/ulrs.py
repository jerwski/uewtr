...
urlpatterns = [
    ...
    path('register/cashpay/<int:record>/', login_required(views.CashPay.as_view()), name='cash_pay'),
    path('register/cashaccept/<int:record>/', login_required(views.CashAccept.as_view()), name='cash_accept'),
