    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('income', models.FloatField(default=0.0, validators=[validators.my_validator.positive_value])),
                ('expenditure', models.FloatField(default=0.0, validators=[validators.my_validator.positive_value])),
