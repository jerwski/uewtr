...
urlpatterns = [
	...
	path('new_product/<int:company_id>/<int:document_id>/', login_required(views.NewProductAddView.as_view()), name='new_product'),
	path('delete_product/<int:record>/<int:company_id>/<int:document_id>/', login_required(views.AccountancyProductDelete.as_view()), name='delete_product'),
