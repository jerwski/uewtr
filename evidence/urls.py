...
urlpatterns = [
    ...
    path('monthly/payroll/print/<str:choice_date>/', views.MonthlyPayrollPrintView.as_view(),name='monthly_payroll_print'),
    path('monthly/payroll/pdf/send/<str:choice_date>/', views.PayrollPdf.as_view(),name='monthly_payroll_pdf'),
