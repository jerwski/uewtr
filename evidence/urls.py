...
urlpatterns = [
    ...
    path('monthly-payroll/month=<int:month>/year=<int:year>/', login_required(views.MonthlyPayrollView.as_view()), name='monthly_payroll_view'),
	...
	path('advances/print/employee=<int:employee_id>/month=<int:month>/year=<int:year>/', login_required(views.AccountPaymentPrintView.as_view()), name='advances_print'),
]
